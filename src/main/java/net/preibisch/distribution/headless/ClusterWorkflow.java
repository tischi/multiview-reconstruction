...
//	}
	...
	public static void run(FusionParams params, String taskPath) throws IOException, JSchException, SftpException, SpimDataException {

		File xmlFile = XMLFile.fromStitchFolder(params.getXml());
		String inputPath = xmlFile.getAbsolutePath();
		...
		XMLFile inputFile = new XMLFile(inputPath, params.getBb(), params.getSpimData(), params.getDownsampling(),
